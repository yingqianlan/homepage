    ...
    b.fn.fullpage = function(c) {
        ...
        function z(a, d) {
            if (l[a]) {
                ...
                a)
                    ...
                    c = "top", f = b.fn.fullpage.moveSectionUp;
                if (0 < d.length)
        ...
        function ga() {
            ...
            if (C) {
                ...
                clearTimeout(ia), ia = setTimeout(function() {
        ...
        function la(a) {
            ...
            if (c.paddingTop || c.paddingBottom)
                b = a, b.hasClass("fp-section") || (b = a.closest(".fp-section")), a = parseInt(b.css("padding-top")) + parseInt(b.css("padding-bottom")), b = h - a;
            return b
        }
        function aa(a, b) {
            b ? ea(g) : O(g);
